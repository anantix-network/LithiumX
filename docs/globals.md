...
- [LithiumXQueue](classes/LithiumXQueue.md)
- [LithiumXRest](classes/LithiumXRest.md)
- [Plugin](classes/Plugin.md)
- [Structure](classes/Structure.md)
- [TrackUtils](classes/TrackUtils.md)
...
- [PlayerUpdate](interfaces/PlayerUpdate.md)
...
- [TrackPluginInfo](interfaces/TrackPluginInfo.md)
...
- [TrackSourceName](type-aliases/TrackSourceName.md)

## Variables

- [bassBoostEqualizer](variables/bassBoostEqualizer.md)
- [softEqualizer](variables/softEqualizer.md)
- [trebleBassEqualizer](variables/trebleBassEqualizer.md)
- [tvEqualizer](variables/tvEqualizer.md)
- [vaporwaveEqualizer](variables/vaporwaveEqualizer.md)
